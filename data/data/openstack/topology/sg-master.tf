...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_icmp_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_mcs_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_ssh_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_icmp_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_dns_tcp_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_ssh_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_dns_udp_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_dns_tcp_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_mdns_udp_v6" {
  count             = var.use_ipv6 ? 1 : 0
  direction         = "ingress"
  ethertype         = "IPv6"
  protocol          = "udp"
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_dns_udp_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_https_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_mdns_udp_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_vxlan_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_https_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_geneve_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_vxlan_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_ovndb_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_geneve_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_internal_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_ovndb_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_internal_udp_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_internal_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_kube_scheduler_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_internal_udp_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_kube_controller_manager_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_kube_scheduler_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_kubelet_secure_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_kube_controller_manager_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_etcd_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_kubelet_secure_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_services_tcp_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_etcd_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_services_udp_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_services_tcp_v6]
}
...
resource "openstack_networking_secgroup_rule_v2" "master_ingress_vrrp_v6" {
  ...
  depends_on = [openstack_networking_secgroup_rule_v2.master_ingress_services_udp_v6]
}
